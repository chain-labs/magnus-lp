...
export default function Pricing() {
	...
	return (
		<section className="relative text-foreground py-[120px] px-[64px]">
			<div className="w-full max-w-7xl mx-auto">
				...
				<div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-12">
					...
					<div className="inline-flex items-center p-[4px] rounded-[8px] border border-[#040D26]">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					{plans.map((plan) => (
						<div
							key={plan.title}
							className={cn(
								"relative rounded-[12px] transition-all duration-300 flex flex-col",
