			...
			>
				<div className="flex flex-col gap-[24px]">
					<div className="flex flex-col">
						...
						<p className="text-[14px] md:text-[20px] leading-[20px] md:leading-[32px] text-[#cdcfd4]">
							{founder.position}
						</p>
					</div>
					<p className="text-[16px] leading-[24px] text-[#9b9ea8]">
						{founder.bio}
					</p>
				</div>
				<ol className="flex flex-col gap-[16px]">
					{founder.credentials.map((credential, credIndex) => (
						...
						>
							...
							<p className="text-[16px] leading-[24px] text-[#c0c2c7]">
								{credential}
							</p>
						</li>
					))}
		...
		>
			<div className="max-w-[848px] mx-auto flex flex-col gap-[80px]">
				<div className="flex flex-col gap-[16px]">
					...
					<p className="text-[16px] md:text-[20px] leading-[24px] md:leading-[32px] text-[#a1a6b3]">
				...
				{meetTheFounderData.heroImage && (
					<div
						...
						role="img"
						aria-label="Magnus Hathaway Founders"
						style={{
