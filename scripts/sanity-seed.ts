    ...
    plans: [
      {
        ...
        badge: '',
        prices: [
          { _key: 'price1', periodKey: 'monthly', amount: 19 },
          { _key: 'price2', periodKey: 'quarterly', amount: 49 },
          { _key: 'price3', periodKey: 'yearly', amount: 199 },
        ],
        ctaText: 'Get Started',
      ...
      },
      {
        ...
        badge: 'Most Popular',
        prices: [
          { _key: 'price1', periodKey: 'monthly', amount: 29 },
          { _key: 'price2', periodKey: 'quarterly', amount: 79 },
          { _key: 'price3', periodKey: 'yearly', amount: 299 },
        ],
        ctaText: 'Get Started',
        ctaLink: 'https://cal.com/magnushathaway/30min',
        features: [
      ...
      },
      {
        ...
        badge: '',
        prices: [
          { _key: 'price1', periodKey: 'monthly', amount: 49 },
          { _key: 'price2', periodKey: 'quarterly', amount: 129 },
          { _key: 'price3', periodKey: 'yearly', amount: 499 },
        ],
